		...
		<form method="post" id="magicuse_form_${mid}" action="props.action?mid=${mid}&idtype=${idtype }&id=${id }">
			...
			<div class="magic_info">
				...
				<div>
					<h4>修改时间</h4>
					<p>
						<input type="text" name="newdateline" value="${sns:sgmdate(pageContext.request,'yyyy-MM-dd HH:mm',blog.dateline,false) }" onclick="showcalendar(event,this,1,'1970-1-1', '${sns:sgmdate(pageContext.request,'yyyy-MM-dd',blog.dateline,false) }')" />
					</p>
				</div>
				<p class="btn_line">
