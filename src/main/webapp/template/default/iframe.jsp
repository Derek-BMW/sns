...
<html>
 <head>
  ...
  <title><c:if test="${not empty space}">${sNames[space.uid]} - </c:if>${sConfig.sitename}</title>
 ...
 <body scroll="no">
  ...
  <table border="0" cellPadding="0" cellSpacing="0" height="100%" width="100%">
   <tr>
    <td height="26" class="link_td">
     <img src="image/icon/profile.gif" align="absmiddle"> <a href="${sGlobal.refer}">返回我的空间</a> <span class="pipe">|</span>
   ...
   <tr>
    <td><iframe id="url_mainframe" frameborder="0" scrolling="yes" name="main" src="${url}" style="height: 100%; visibility: inherit; width: 100%; z-index: 1; overflow: visible;"></iframe></td>
   </tr>
  </table>
  <div id="divshare" style="position: absolute; left: 50%; top: 100px; width: 450px; w\idth: 434px; margin-left: -225px; border: 8px solid #999; background: #FFF; display: none; padding: 20px;">
   <form method="post" id="shareform" name="shareform" action="main.action?ac=share&type=link">
    <table>
     <tr>
      <td>
     ...
     <tr>
      <td>
       <input type="hidden" name="refer" value="zone.action?do=share">
    ...
    <ul class="box" style="text-align: left;">
     <li id="share_li">
      <div class="title"><a href="zone.action?uid=${space.uid}">${sNames[space.uid]}</a> 分享了一个网址 <span class="gray">${timestamp}</span></div>
      <div class="feed">
       <div id="preview" class="detail">${url}</div>
