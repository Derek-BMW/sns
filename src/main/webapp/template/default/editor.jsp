...
<html>
 <c:choose><c:when test="${sns:snsEmpty(param.op)}">
  <head>
  ...
  <body style="overflow-y: hidden">
   <table cellpadding="0" cellspacing="0" width="100%" id="dvHtmlLnk" style="display: none">
    <tr><td height="31">
     <table width="100%" border="0" cellpadding="0" cellspacing="0" class="edTb">
      <tr><td height="31" style="padding-left: 5px;">
       <!--纯文本状态工具栏-->
       <div class="toobar"><div class="icons tble">
   ...
   <div>
    <table cellpadding="0" cellspacing="0" width="100%" height="100%" id="dvhtml"><tr><td height="31">
     <table width="100%" border="0" cellpadding="0" cellspacing="0" class="edTb">
      <tr><td height="31" style="padding-left: 3px">
       <!--多媒体状态工具栏-->
       <div class="toobar">
        <div class="icons tble">
         ...
         <c:if test="${!sns:snsEmpty(param.doodle)}"><a href="javascript:;" class="icoDoodle" id="doodleBox" onClick="doodleBox(event, this.id);return false;" title="涂鸦"></a></c:if>
         <a href="javascript:;" class="icoRenew" onClick="renewContent();return false;" title="恢复内容"></a>
         <c:choose>
          <c:when test="${!sns:snsEmpty(param.allowhtml)}"><input type="checkbox" value="1" name="switchMode" id="switchMode" style="float: left; margin-top: 6px !important; margin-top: 2px" onClick="setMode(this.checked)" onMouseOver="fSetModeTip(this)" onMouseOut="fHideTip()"></c:when>
          <c:otherwise><input type="hidden" value="1" name="switchMode" id="switchMode"></c:otherwise>
         </c:choose>
        </div>
     ...
     <table cellpadding="0" cellspacing="0" style="background-color: #999999; height: 100%; width: 100%; overflow: hidden">
      <tr><td>
       ...
       <!--
        function blank_load() {
         var inihtml = '';
         var obj = parent.document.getElementById('sns-ttHtmlEditor');
         if(obj) {
          inihtml = obj.value;
         }
        ...
        if(document.all){
         document.write('<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" id="divEditor"><tr><td style=""><IFRAME class="HtmlEditor" ID="HtmlEditor" name="HtmlEditor" style="height:100%;width:100%" frameBorder="0" marginHeight=0 marginWidth=0 src="editor.action?op=blank" onload="blank_load();"></IFRAME></td></tr></table>');
        }else{
         document.write('<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" id="divEditor"><tr><td style="background-color:#ffffff"><IFRAME class="HtmlEditor" ID="HtmlEditor" name="HtmlEditor" style="height:100%;width:100%;margin-left:1px;margin-bottom:1px;" frameBorder="0" marginHeight=0 marginWidth=0 src="editor.action?op=blank" onload="blank_load();"></IFRAME></td></tr></table>');
        }
       //-->
       </script>
   ...
   <input type="hidden" name="sns-editstatus" id="sns-editstatus" value="html">
  </body>
 </c:when><c:otherwise>
  <head>
   <meta http-equiv="Content-Type" content="text/html;charset=${snsConfig.charset}" />
