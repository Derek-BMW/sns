  ...
  <c:choose>
   <c:when test="${sGlobal.supe_uid>0}">
       ...
       <%
            ...
            String nickName = nameObj == null?null:nameObj.toString();
            if(nickName != null && !"".equals(nickName)){
       %>
            <a href="zone.action?uid=${sGlobal.supe_uid}" class="login_thumb"><img src="${herderIcon}"/></a>
            <a href="zone.action?uid=${sGlobal.supe_uid}" class="loginName"><image src="image/thirdLogin/qq/16-16.png" width="11px" height="11px"/>${nickName}</a>
       <%
            }else{
        %>
   ...
   <c:otherwise>
   <div style="color:#fff; line-height:38px;">
